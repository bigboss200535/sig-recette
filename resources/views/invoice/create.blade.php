							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted">
											<a href="#" class="text-muted text-hover-primary">Bills</a>
										</li>
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px">Add New</span>
										</li>
													...
													<div class="mb-0">
														<div class="row gx-10 mb-5">
															<div class="col-lg-6">
																...
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="Nom/Raison sociale " value="Florence"/>
																</div>
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="Telephone" value="91…."/>
																</div>
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="Canton" value="XX"/>
																</div>
																<div class="mb-5">
																	<textarea name="notes" class="form-control form-control-solid" rows="3" placeholder="Address">ZZ</textarea>
																</div>
															</div>
															<div class="col-lg-6">
																<label class="form-label fs-6 fw-bolder text-white-700 mb-3" style="color:white">Bill To</label>
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="NIC" value='000013' />
																</div>
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="Zone fiscale" value='1' />
																</div>
																<div class="mb-5">
																	<input type="text" class="form-control form-control-solid" placeholder="Quartier/Village" value='YY' />
																</div>
																<div class="mb-5">
																	<textarea name="notes" class="form-control form-control-solid" rows="3" placeholder="Coordonnées GPS" >XY</textarea>
																</div>
															</div>
														</div>
															...
															<table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" data-kt-element="items">
																...
																<tbody>
																	<tr class="border-bottom border-bottom-dashed" data-kt-element="item">
																		<td class="pe-7">
																			<input type="text" class="form-control form-control-solid mb-2" name="name" placeholder="Item name" value="Redevance d’occupation du domaine public"/>
																			<input type="text" class="form-control form-control-solid" name="description" placeholder="Description" value="Superficie du domaine public occupée"/>
																		</td>
																		<!-- <td class="pe-7">
																		...
																		<td class="ps-0">
																			<input class="form-control form-control-solid mb-2" type="number" min="1" name="quantity" placeholder="1" value="2" data-kt-element="quantity" />
																			<input class="form-control form-control-solid" type="text" name="mesure" placeholder="m3" value="m3"/>
																		</td>
																		<td>
																			<input type="text" class="form-control form-control-solid mb-2 text-end" name="price" placeholder="0.00" value="1000.00" data-kt-element="price" />
																			<input type="text" class="form-control form-control-solid text-end" name="taxation" placeholder="Taxation/an" value="12"/>
																		</td>
																		<td class="pt-8 text-end text-nowrap">FCFA
																		<span data-kt-element="total">24000.00</span></td>
